Ext.define('FMS.app.guangqi.module.ContractGuangqi', {
	// extend : 'Plugin.grid.Grid',
	extend : 'Plugin.grid.Show',
	alias : 'widget.FMSappguangqimoduleContractGuangqi',
			...
			Ext.Ajax.request({
	            ...
	            success: function (response, options) {
	            	...
	            	if(resultJSON != null){
	        			...
	        			me.formWindowUp(selection[0].data.contractId,selection[0].data.serviceBeginDate,effected,selection[0].data.insuranceTypeGuangqi);
	            	}
	            },
	            failure: function (response, options) {
	                Ext.MessageBox.alert('失败', '请求超时或网络故障,错误编号：' + response.status);
	 ...
	 * 修改 弹出窗口
	 */
	formWindowUp : function(contractId,serviceBeginDate,effected,insuranceTypeGuangqi){
		var me = this;
		var idParams = {
...
//							            	allowBlank : false,
							            	...
							            	emptyText: '系统唯一生成,无需填写'
							    	          ...
							    	          items:[{
						    		                ...
						    		                xtype : 'ExtPluginFormCombobox',
						    		                tCode : 'c_insurance_code_guangqi',
						    		                typeAhead :false,
						    		                editable : false,
						    		                allowBlank: false,
						    		                name: 'insuranceCode',
								    	          ...
								    	          items:[{
						    		    			    ...
						    		    			    listeners: {
						    		    			    	"change": function (val) {
						    		    			    		...
						    		    			    		var sericeEndDate = Ext.util.Format.date(Ext.Date.add(new Date(serviceBeginDate),Ext.Date.DAY,364),"Y-m-d");
						    		    			    ...
						    		    			    xtype: 'datefield',
						    		    			    format: 'Y-m-d',
						    		    			    value: Ext.util.Format.date(Ext.Date.add(new Date(),Ext.Date.DAY,+365),"Y-m-d")
							    		            }]
								            	}]
					      }]
					  	}, {
...
//		Ext.Ajax.request({
//            url: StaticSetting.absUrl + "/mis/contract/getContractClaim",
//            params : {
...
//        });
		...
		_win.addTabClientPanel(Ext.create('Plugin.grid.UploadGridGuangqi', {
					...
					tCode : 'c_document_type_guangqi_chudan',
