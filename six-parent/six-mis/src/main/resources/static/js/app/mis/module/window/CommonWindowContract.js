Ext.define('FMS.app.mis.module.window.CommonWindowContract', {
	extend : 'Ext.window.Window',
	alias : 'widget.FMSAppMisModulewindowCommonWindowContract',
	...
	initComponent : function(a, b, c, d) {
		...
		me.items = _items;
		if(!me.hiddenButtons)
			me.buttons = me.getButtons(me.autoBrand);
		...
		return [{
			...
			handler : function() {
				if(me.onSave)
					...
					if(autoBrand == 'c_document_type_chudan_dazhong' || autoBrand == 'c_document_type_chudan_changcheng') {
						if(me.idParams.businessId != undefined || me.idParams.businessId != null || me.idParams.businessId != null) {
							Ext.MessageBox.show({
				    			title : '警告',
				    			msg : '请上传购车发票！',
						...
						Ext.Ajax.request({
							url: StaticSetting.absUrl + "/mis/myFile/getlist",
							params : {
								businessId : me.idParams.businessId,
								businessType : '4',
								fileBusinessType : '19'
							},
							method: 'GET',
