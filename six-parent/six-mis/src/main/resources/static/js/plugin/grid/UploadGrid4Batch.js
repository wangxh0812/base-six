Ext.define('Plugin.grid.UploadGrid4Batch', {
	extend : 'Plugin.grid.Show',
	alias : 'widget.PlugingridUploadGrid4Batch',
			...
			items : [{
				...
				handler : function() {
					...
					for(var i=0;i<selection.length;i++) {
						fileIds[i] = selection[i].data["fileId"];
					...
					var url = StaticSetting.absUrl+ '/mis/myFile/downloadFile4Batch?fileIds=' + fileIds;
